<div class="modal fade" id="inputpemasukanform" tabindex="-1" aria-labelledby="inputpemasukanformLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="inputpemasukanformLabel">Input Pemasukan</h5>
