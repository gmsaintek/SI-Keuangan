<div class="modal fade" id="inputPengeluaranform" tabindex="-1" aria-labelledby="inputPengeluaranformLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="inputPengeluaranformLabel">Input pengeluaran</h5>
