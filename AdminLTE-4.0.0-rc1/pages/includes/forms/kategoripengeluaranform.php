<div class="modal fade" id="kategoripengeluaranform" tabindex="-1" aria-labelledby="kategoripengeluaranformLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="kategoripengeluaranformLabel">Input Pengeluaran</h5>
