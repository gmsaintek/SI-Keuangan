<div class="modal fade" id="pengeluaran_inputform" tabindex="-1" aria-labelledby="pengeluaran_inputformLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="pengeluaran_inputformLabel">Input pengeluaran</h5>
