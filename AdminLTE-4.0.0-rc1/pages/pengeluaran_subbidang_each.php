                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-sm-end">
                                        ...
                                        <li class="breadcrumb-item"><a href="pengeluaran_subbidang.php">Semua Sub-bidang</a></li>
                            ...
                            <div class="row">
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="modal-container">
                                        <?php include 'includes/forms/pengeluaran/in_subbidang_input_form.php'; ?>
                                    </div>
                                    <div class="modal-container">
                                        <?php include 'includes/forms/cetak_laporan/subbidang_each.php'; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal-container">
                                                        <?php include 'includes/forms/pengeluaran/in_subbidang_edit_form.php'; ?>
                                                    </div>
                                                    <div class="modal-container">
