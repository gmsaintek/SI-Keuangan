            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-6">
                <div class="small-box text-bg-danger">
                  ...
                  <a href="<?= base_url('pengeluaran_input') ?>" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                    More info
                    <i class="bi bi-link-45deg"></i>
                  </a>
                </div>
              ...
              <div class="col-lg-4 col-6">
                <div class="small-box text-bg-warning">
                  ...
                  <a href="<?= base_url('transaksi_all') ?>" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                      More info
                      <i class="bi bi-link-45deg"></i>
                    </a>
                </div>
