                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="d-flex gap-2 mb-3">
                            ...
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#cetaklaporan_bidang_each">
                    ...
                    <?= view('includes/forms/pengeluaran/in_bidang_input_form', [
                        'actionUrlStore' => base_url('pengeluaran_bidang_each/store')
                    ]) ?>
                    <?= view('includes/forms/cetak_laporan/bidang_each', [
                        'actionUrl' => 'pengeluaran_bidang_each/cetak',
                        'modalTitle' => 'Cetak Laporan Pemberdayaan Masyarakat',
                        'modalId' => 'cetaklaporan_bidang_each' // <-- tambahkan ini!
                    ]) ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?= view('includes/forms/pengeluaran/in_bidang_edit_form', [
                                                'row' => $row,
                                                'actionUrlUpdate' => base_url('pengeluaran_bidang_each/update/'.$row['id'])
                                            ]) ?>
                                            <?= view('includes/forms/konfirmasi/hapus', [
                                                'row' => $row,
                                                'actionUrl' => base_url('pengeluaran_bidang_each/delete/' . $row['id'])
                                            ]) ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
