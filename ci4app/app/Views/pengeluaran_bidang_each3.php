...
<head>
  ...
  <title>Penyelenggaraan Pemerintahan Desa</title>
        ...
        <div class="app-content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Penyelenggaraan Pemerintahan Desa</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Penyelenggaraan Pemerintahan Desa</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="d-flex gap-2 mb-3">
                            ...
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#cetaklaporan_bidang_each3">
                                <i class="bi bi-printer"></i> <span>Cetak Laporan</span>
                            </button>
                        </div>
                    </div>
                    <?= view('includes/forms/pengeluaran/in_bidang_input_form', [
                        'actionUrlStore' => base_url('pengeluaran_bidang_each3/store')
                    ]) ?>
                    <?= view('includes/forms/cetak_laporan/bidang_each', [
                        'actionUrl' => 'pengeluaran_bidang_each3/cetak',
                        'modalTitle' => 'Cetak Laporan Penyelenggaraan Pemerintahan Desa',
                        'modalId'    => 'cetaklaporan_bidang_each3'
                    ]) ?>
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?= view('includes/forms/pengeluaran/in_bidang_edit_form', [
                                                'row' => $row,
                                                'actionUrlUpdate' => base_url('pengeluaran_bidang_each3/update/'.$row['id'])
                                            ]) ?>
                                            <?= view('includes/forms/konfirmasi/hapus', [
                                                'row' => $row,
                                                'actionUrl' => base_url('pengeluaran_bidang_each3/delete/' . $row['id'])
                                            ]) ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
